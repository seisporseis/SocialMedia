...
<div class="flex items-center lg:justify-center flex-col">
    <div class="w-full flex justify-center items-center py-6 lg:gap-10 gap-6">
        ...
        <div>
            <div class="flex items-center lg:gap-4 gap-2">
                ...
                @auth
                    ...
                    <a href="{{ route('profile.index') }}" class="border border-transparent p-2 rounded-md flex items-center gap-1 text-teal-900 text-xs underline hover:bg-slate-100 hover:shadow-sm cursor-pointer">
            ...
            <div class="flex items-center lg:gap-6 py-5">
                ...
                <p class="flex flex-col items-center text-teal-900 lg:text-lg mb-3 font-bold">
                   {{ $user->posts->count() }}
                    <span class="font-thin ">Publicaciones</span>
                </p>
            </div>           
